...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/adviser'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: Adviser) {
        return item.id;
    }
    registerChangeInAdvisers() {
        this.eventSubscriber = this.eventManager.subscribe('adviserListModification', (response) => this.loadAll());
    }
