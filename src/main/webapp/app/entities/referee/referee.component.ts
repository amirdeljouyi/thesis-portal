...
currentAccount: any;
    ...
    trackId(index: number, item: Referee) {
        return item.id;
    }
    registerChangeInReferees() {
        this.eventSubscriber = this.eventManager.subscribe('refereeListModification', (response) => this.loadAll());
    }
