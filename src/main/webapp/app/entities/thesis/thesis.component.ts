...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/thesis'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: Thesis) {
        return item.id;
    }
    ...
    registerChangeInTheses() {
        this.eventSubscriber = this.eventManager.subscribe('thesisListModification', (response) => this.loadAll());
    }
